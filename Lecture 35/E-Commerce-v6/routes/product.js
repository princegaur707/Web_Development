...
router.get('/products/:id', async (req, res) => {
    ...
    try {
        ...
        //certain coll ection with documents from another collection
...
router.get('/products/:id/edit', IsProductAuthor ,IsLoggedIn, async (req, res) => {
...
router.patch('/products/:id/', IsProductAuthor, IsLoggedIn, validateProduct, async (req, res) => {
