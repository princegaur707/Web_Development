...
//Promise is better than call back because they have inbuilt error handling
//mechanism(resolve, reject functions)
...
downloadFile('http://facebook.com/profile.jpg')
    ...
    //this below .catch works for every .then loop above
    .catch((err) => {
        console.log("!!!!!!!Something-------went------wrong!!!!!!!");
        // console.log(err);
        console.log(err.message); //this command will be used if we want to give our customized
        //msg used in lines 85 and 86
    });


/* In Lines 148, 149 
    BTS: compressFile function will directly replace resolve(path) so, 
    in downloadFile function itself compressFile(path) will be called
*/